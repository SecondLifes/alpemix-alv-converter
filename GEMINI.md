# Alpemix ALV Converter — Gemini CLI / Antigravity Context
...
per-topic rules in `.agents/rules/*.md` (`.gemini/rules/project-rules.md`
points at the ones that matter for this stack). Read them when the task
they govern comes up — they are as binding here as they are for any other
tool this kit supports.

> **Why this file exists:** every kit generated from this scaffold shipped
> a `.gemini/rules/project-rules.md` and an AI-tool table naming it as
